...
<?php 
  ...
  if (isset($_GET['delete'])) {
	...
	$deletestmt = $conn->query("DELETE FROM vote03 WHERE id = $delete_id");
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
					<h2 class="font-w600 title mb-2 mr-auto ">No.3</h2><a href="export/03.php" class="button-87" role="button">EXPORT VOTE NO.3</a>
				</div>
						...
						<div class="card">
							<div class="table-data">
								<div class="order">
									...
									<form action="del/coded3" method="POST">
									<table class="table">
										<thead>
											<tr>
										...
										<?php 
											...
											$stmt = $conn->query("SELECT * FROM vote03 Order By id DESC");
				...
				$.ajax({
					...
					.done(function() {
						...
						Swal.fire({
							...
							document.location.href = 'no3.php';
