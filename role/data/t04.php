...
<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        $deletestmt = $conn->query("DELETE FROM vote04 WHERE id = $delete_id");
...
<body>
    ...
    <form action="del/coded4.php" method="POST">
    ...
    <?php 
        ...
        $stmt = $conn->query("SELECT * FROM vote04 Order By id DESC");
				...
				$.ajax({
					...
					.done(function() {
						...
						Swal.fire({
							...
							document.location.href = 't04.php';
