...
<?php 
  ...
  if (isset($_GET['delete'])) {
	...
	if ($deletestmt) {
		...
		header("refresh:1; url=infoadmin_pro.php");
...
<head>
    ...
    <title>Professor Admin info</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
					<h2 class="font-w600 title mb-2 mr-auto ">Professor Admin info</h2>
				</div>
								...
								<div class="order">
									...
									<table class="table">
										...
										<?php 
											...
											$stmt = $conn->query("SELECT * FROM users where urole = 'professor_admin'");
				...
				$.ajax({
					...
					.done(function() {
						...
						Swal.fire({
							...
							document.location.href = 'infoadmin_pro.php';
