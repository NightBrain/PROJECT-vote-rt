...
<head>
    ...
    <title>Professor Complete info</title>
    <!-- Favicon icon -->
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
					<h2 class="font-w600 title mb-2 mr-auto ">Professor Complete info</h2>
				</div>
					...
					<div class="">
						<div class="table-data" style="height: 800px">
								<div class="order">
									...
									<iframe src="table/dprofessorc.php" width="100%" height="100%" class="rounded-5" ></iframe>
								</div>
							</div>
						</div>
					</div>
