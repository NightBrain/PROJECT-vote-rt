							...
							<li class="nav-item dropdown notification_dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
                                    <div id="dlab_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
										<a href="rp.php" style="text-decoration: none; color: #fff;">
											<?php include 'noti/text.php';?>
										</a>
										</ul>
									</div>
                                    <a class="all-notification" href="rp.php" style="text-decoration: none; color: #fff;">See all notifications <i class="ti-arrow-right"></i></a>
                                </div>
							</li>
