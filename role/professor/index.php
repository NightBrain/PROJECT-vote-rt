    ...
    <div class="inner-container bgvid inner">
      <form action="signin_db.php" method="post">
        <div class="box">
          ...
          <input class="bdrd d-none" type="text" placeholder="Username" name="password" value="professorcmru">
          <button class="button-63 mt-4" type="submit" name="signin">LOG IN</button>
          <hr class="mt-5">
