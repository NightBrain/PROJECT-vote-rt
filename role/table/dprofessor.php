...
<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deletestmt) {
            ...
            header("refresh:1; url=dprofessor.php");
...
<body>
    ...
    <form action="del/dinp.php" method="POST">
    ...
    <?php 
        ...
        $stmt = $conn->query("SELECT * FROM users where urole = 'professor' Order By id DESC");
				...
				$.ajax({
					...
					.done(function() {
						...
						Swal.fire({
							...
							document.location.href = 'dprofessor.php';
