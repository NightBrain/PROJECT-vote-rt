...
<?php 
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($deletestmt) {
            ...
            header("refresh:1; url=dstudent.php");
...
<body>
    ...
    <form action="del/dins.php" method="POST">
    ...
    <?php 
        ...
        $stmt = $conn->query("SELECT * FROM users where urole = 'student' Order By id DESC");
				...
				$.ajax({
					...
					.done(function() {
						...
						Swal.fire({
							...
							document.location.href = 'dstudent.php';
